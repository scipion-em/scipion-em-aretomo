...
Default installation path assumed is ``software/em/aretomo-1.1.1``, if you want to change it, set *ARETOMO_HOME* in ``scipion.conf`` file to
the folder where the AreTomo is installed. Depending on your CUDA version you might want to change the default binary from ``AreTomo_1.1.1_Cuda101_04-06-2022``
...
1.0.6, 1.0.8, 1.0.10, 1.0.12, 1.1.0, 1.1.1
...
Detailed manual can be found in ``software/em/aretomo-1.1.1/bin/AreTomoManual-03-24-2022.pdf``
