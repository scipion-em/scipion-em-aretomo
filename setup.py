...
from aretomo import __version__
...
setup(
    ...
    name='scipion-em-aretomo',  # Required
    ...
    description='Plugin to use AreTomo program within the Scipion framework',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-aretomo',  # Optional
    ...
    install_requires=['scipion-em', 'scipion-em-tomo',
                      'scipion-pyworkflow>=3.0.30', 'numpy>=1.23.0'],  # Optional
    ...
    entry_points={
        'pyworkflow.plugin': 'aretomo = aretomo'
    },
)
